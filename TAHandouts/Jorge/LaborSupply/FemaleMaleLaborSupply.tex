...
\begin{frame}
	...
	\begin{itemize}
		...
		\item After marriage, husband's earnings are $\ln y_{a}^m = \mu^m + \Psi_{0m}^m + \varepsilon_{a}^m$ 					
		\end{itemize}
\end{frame}
...
\begin{frame}
	\frametitle{Model: Males, Dynamic Problem}
	\begin{itemize}
		\item The model needs the following extensions to fit the data adequately:
		\begin{enumerate}
		\item
		\item
		\item
