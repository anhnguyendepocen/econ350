...
\begin{enumerate}
\item Structural (S): it recovers some of all of the parameters of the structure of the model.
...
Use the data ``womans.csv'' to estimate the model. The file ``readmewomans.txt'' describes the data base.
\end{exercise}
